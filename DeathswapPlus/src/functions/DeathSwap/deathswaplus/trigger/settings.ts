...
MCFunction('deathswaplus/trigger/settings', () => {
  ...
  execute.if.entity('@e[scores={Select=2}]').run.execute.if.entity('@e[name=Values,scores={SpeedyStart=0}]').run.tellraw('@a', [{"text":"Speedy Start","color":"gray"},{"text":" [YES]","bold":"true","color":"green","clickEvent":{"action":"run_command","value":"/trigger Select set 32"}}])
  execute.if.entity('@e[scores={Select=2}]').run.execute.if.entity('@e[name=Values,scores={SpeedyStart=1}]').run.tellraw('@a', [{"text":"Speedy Start","color":"gray"},{"text":" [NO]","bold":"true","color":"red","clickEvent":{"action":"run_command","value":"/trigger Select set 33"}}])
